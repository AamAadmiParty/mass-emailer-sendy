...
<script type="text/javascript">
	$(document).ready(function() {
		$("#import-unsubscribe-all-form").validate({
			rules: {
				csv_file: {
					required: true
				}
...
<div class="row-fluid">
    ...
    <div class="span10">
    	<h2><?php echo _('Mass unsubscribe from all lists and all brands via CSV file');?></h2><br/>
	    <form action="<?php echo get_app_info('path')?>/includes/subscribers/import-unsubscribe-from-all-lists.php" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="import-unsubscribe-all-form">
	    ...
	    <form action="<?php echo get_app_info('path')?>/includes/subscribers/line-unsubscribe-from-all-lists.php" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="line-import-form">
	        ...
	        <label class="control-label" for="line"><?php echo _('Email to unsubscribe from all lists and all brands');?></label>
            <div class="control-group">
		    	<div class="controls">
